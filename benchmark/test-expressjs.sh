...
echo "==========================================="
autocannon -c 100 -d 30 -p 10 "$BASE_URL/health" > "$RESULT_DIR/expressjs-health.txt" 2>&1
...
echo "======================================"
autocannon -c 50 -d 30 -p 1 "$BASE_URL/users" > "$RESULT_DIR/expressjs-users-read.txt" 2>&1
