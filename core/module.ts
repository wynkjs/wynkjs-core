...
/**
 * Marks a module as global so its exports are available everywhere without explicitly importing the module.
 *
 * @returns A class decorator that marks the target module as global.
 */
