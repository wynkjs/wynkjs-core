...
/**
 * Attaches metadata under the given key to a class or to a class method using the reflect-metadata API.
 *
 * @param metadataKey - The key under which the value is stored
 * @param metadataValue - The value to store
 * @returns A decorator that sets the specified metadata on a class or on a method
 *
 * @example
